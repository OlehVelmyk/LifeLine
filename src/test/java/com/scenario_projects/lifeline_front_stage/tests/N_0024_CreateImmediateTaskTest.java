...
public class N_0024_CreateImmediateTaskTest extends BaseTest {
    private String taskTime, taskName;
    ...
    public void createImmediateTask() {
        ...
        newTask.clickImmediateTab();

        taskTime = newTask.getTaskTime();
        ...
        Assert.assertEquals(patientDetailPage.getDateTaskTime(0), taskTime);
    }
