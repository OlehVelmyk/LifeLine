...
public class N_0027_UndoneTaskTest extends BaseTest {
    private String timeData, taskName;
    private String undoneTask = "Undone";
    ...
    public void undoneTask() {
        ...
        taskPage.clickUndoneTaskButton();
        ...
        Assert.assertTrue(taskPage.checkTaskStatus(undoneTask), "Failed! Status task doesn't equal " + undoneTask);
